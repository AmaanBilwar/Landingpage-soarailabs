...
import * as d_blogPosts_2 from "../content/blog/why-us.mdx?collection=blogPosts"
import * as d_blogPosts_1 from "../content/blog/mcps-can-be-packages.mdx?collection=blogPosts"
import * as d_blogPosts_0 from "../content/blog/introducing-glide.mdx?collection=blogPosts"
import { _runtime } from "fumadocs-mdx/runtime/next"
import * as _source from "../source.config"
export const blogPosts = _runtime.doc<typeof _source.blogPosts>([{ info: {"path":"introducing-glide.mdx","fullPath":"content\\blog\\introducing-glide.mdx"}, data: d_blogPosts_0 }, { info: {"path":"mcps-can-be-packages.mdx","fullPath":"content\\blog\\mcps-can-be-packages.mdx"}, data: d_blogPosts_1 }, { info: {"path":"why-us.mdx","fullPath":"content\\blog\\why-us.mdx"}, data: d_blogPosts_2 }]);
